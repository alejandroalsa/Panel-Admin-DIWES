...
const Plugins = [
  ...
  // Bootstrap
  {
    from: 'node_modules/bootstrap/assets/js',
  ...
  // Chart.js
  {
    from: 'node_modules/chart.js/assets/',
    to: 'plugins/chart.js'
  },
  // jQuery UI
  {
    from: 'node_modules/jquery-ui-assets/',
    to: 'plugins/jquery-ui'
  },
  // Flot
  {
    from: 'node_modules/flot/assets/es5/',
    to: 'plugins/flot'
  },
  {
  ...
  // Summernote
  {
    from: 'node_modules/summernote/assets/',
    to: 'plugins/summernote'
  },
  // Bootstrap Slider
  {
    from: 'node_modules/bootstrap-slider/assets/',
    to: 'plugins/bootstrap-slider'
  },
  {
    from: 'node_modules/bootstrap-slider/assets/css',
    to: 'plugins/bootstrap-slider/css'
  },
  // Bootstrap Colorpicker
  {
    from: 'node_modules/bootstrap-colorpicker/assets/js',
    to: 'plugins/bootstrap-colorpicker/js'
  },
  {
    from: 'node_modules/bootstrap-colorpicker/assets/css',
  ...
  // inputmask
  {
    from: 'node_modules/inputmask/assets/',
  ...
  {
    from: 'node_modules/jqvmap-novulnerability/assets/',
    to: 'plugins/jqvmap'
  },
  // jQuery Mapael
  {
  ...
  // jQuery Knob
  {
    from: 'node_modules/jquery-knob-chif/assets/',
    to: 'plugins/jquery-knob'
  },
  // pace-progress
  {
    from: 'node_modules/@lgaitan/pace-progress/assets/',
    to: 'plugins/pace-progress'
  },
  // Select2
  {
    from: 'node_modules/select2/assets/',
    to: 'plugins/select2'
  },
  {
    from: 'node_modules/@ttskch/select2-bootstrap4-theme/assets/',
  ...
  // SweetAlert2
  {
    from: 'node_modules/sweetalert2/assets/',
  ...
  // jQuery Validate
  {
    from: 'node_modules/jquery-validation/assets/',
    to: 'plugins/jquery-validation'
  },
  // bs-custom-file-input
  {
    from: 'node_modules/bs-custom-file-input/assets/',
    to: 'plugins/bs-custom-file-input'
  },
  // bs-stepper
  {
    from: 'node_modules/bs-stepper/assets/',
  ...
  // dropzonejs
  {
    from: 'node_modules/dropzone/assets/',
    to: 'plugins/dropzone'
  },
  // uPlot
  {
    from: 'node_modules/uplot/assets/',
    to: 'plugins/uplot'
  }
]

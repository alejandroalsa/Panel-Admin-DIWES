<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="assets/img/LOGO/DIWES LOGO.svg" width="100%">
    </a>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/UI/sliders.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Controles deslizantes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/UI/modals.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Modales y Alertas</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="pages/examples/Iniciar Sesión.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Iniciar Sesión v1</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="pages/examples/Registro.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Registro v1</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Iniciar Sesión & Registro v2
                    <i class="fas fa-angle-left right"></i>
                  </p>
                </a>
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="pages/examples/Iniciar Sesión-v2.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Iniciar Sesión v2</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="pages/examples/Registro-v2.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Registro v2</p>
                    </a>
                  </li>
